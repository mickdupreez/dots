...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/mickdupreez/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/mickdupreez/LARBS/master/progs.csv"
